...
const FeaturesSection: React.FC = () => {
  const features = [
    {
      icon: <UserShieldIcon className="w-10 h-10 text-primary-dark" />,
    ...
    {
      icon: <ZapIcon className="w-10 h-10 text-primary-dark" />,
    ...
    {
      icon: <InfoIcon className="w-10 h-10 text-primary-dark" />,
    ...
    {
      icon: <HeartIcon className="w-10 h-10 text-primary-dark" />,
  ...
  return (
    <section className="py-16 sm:py-24 bg-neutral-lightest">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-neutral-darkest">
            Todo lo que necesitas para <span className="text-primary-DEFAULT">comer mejor</span>
          </h2>
          <p className="mt-4 text-lg text-neutral-dark max-w-2xl mx-auto">
            Descubre las herramientas que BONIATO te ofrece para cuidar tu alimentación.
          </p>
        </div>
